...
#' State KPREP EOC Levels Data for Kentucky Public Schools, 2012-2015
#'
#' A dataset with KPREP performance level data
#'
#' @format A dataframe with 288 rows and 11 variables:
#' \describe{
#'   \item{sch_id}{ID number to identify schools & districts}
#'   \item{dist_name}{District name - in this case, it is always "State Total"}
#'   \item{year}{School year}
#'   \item{subject}{Specific subject assessed by KPREP EOC exam}
#'   \item{student_group}{Student subgroup}
#'   \item{n_tested}{Number of students tested}
#'   \item{novice_pct}{Percent of students scoring "Novice" on KPREP}
#'   \item{apprentice_pct}{Percent of students scoring "Apprentice" on KPREP}
...
#' District KPREP EOC Levels Data for Kentucky Public Schools, 2012-2015
#'
#' A dataset with KPREP performance level data
#'
#' @format A dataframe with 50058 rows and 11 variables:
#' \describe{
#'   \item{sch_id}{ID number to identify schools & districts}
#'   \item{dist_name}{District name}
#'   \item{year}{School year}
...
#' School KPREP EOC Levels Data for Kentucky Public Schools, 2012-2015
#'
#' A dataset with KPREP performance level data
#'
#' @format A dataframe with 94590 rows and 12 variables:
#' \describe{
#'   \item{sch_id}{ID number to identify schools & districts}
#'   \item{dist_name}{District name}
#'   \item{sch_name}{School name}
